...
#
# # Tone mapping
fuse_image = io.imread('IMG_20221025_105232_srgb_whiteworld_linear.jpg')
K = 0.15
B = 0.95
eps = 10 ** -10
Iij_HDR = fuse_image
...
Iij_TM_01 = np.clip(Iij_TM, 0, 1)
plt.imshow(np.power(Iij_TM_01, 1 / 2.4))
plt.show()

io.imsave('IMG_20221025_105232_srgb_tonemapped.jpg',np.power(Iij_TM_01, 1 / 2.4))
plt.imshow(Iij_TM_01)
plt.show()
